									...
									<div class="form-group">
										...
										<div class="input-group">
											<span class="input-group-addon"><i
												class="fa fa-file-word-o"></i> </span> <input id="input-22"   type="file" name="input-22"  accept="image/*" class="file-loading">
												...
												<div class="form-group">
													...
													<select class="form-control" name="t_default_video_id"
														...
														<c:forEach var="item" items="${tRooms}"
															varStatus="stat">
															<option  id="t_room_id_${item.id}" ${item.id==tLive.t_room_id ? 'selected="selected"':''}   value="${item.id}">${item.name}</option>
														</c:forEach>
													</select>
												</div>
											</div>
